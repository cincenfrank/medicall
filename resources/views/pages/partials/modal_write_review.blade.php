            ...
            <div class="modal-content bg-dark text-light">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3  align-items-center">
                        ...
                        <input type="text" class="form-control @error('reviewer_name') is-invalid @enderror" id="name" name="reviewer_name">
                        @error('reviewer_name')
                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="mb-3  align-items-center d-flex">
                        ...
                        <select class="form-select w-25 ms-3 align-items-center @error('rating') is-invalid @enderror" name="rating" id="rating">
                    ...
                    <div class="mb-3 align-items-center">
                        ...
                        <input type="email" class="form-control @error('reviewer_email') is-invalid @enderror" id="reviewer_email" name="reviewer_email">
                    ...
                    <div class="mb-3 align-items-center">
                        ...
                        <textarea type="text" class="form-control @error('content') is-invalid @enderror" name="content" id="content" cols="30" rows="5"></textarea>
                        @error('content')
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="modal-footer">
                    ...
                    <button id='submitButton' type="submit" class="btn btn-primary" {{-- data-bs-target="#exampleModalToggle2"
