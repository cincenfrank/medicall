<template>
    ...
    <div class="container">
        ...
        <div v-if="doctorsArray">
            ...
            <div
                class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 justify-content-center"
            >
                <div
...
export default {
    ...
    methods: {
        ...
        onDoctorSelected(doctorSlug) {
            window.axios
                .get(`/api/filter/doctors/${doctorSlug}`)
                .then((resp) => {
        ...
        onServiceSelected(serviceSlug) {
            window.axios
                .get(`/api/filter/services/${serviceSlug}`)
                .then((resp) => {
