<template>
  ...
  <div
    class="carousel d-flex align-items-center position-relative"
    :style="styleProps"
  >
    ...
    onScrollRequested(isForward) {
      ...
      if (isForward) {
        ...
        const newScrollPosition =
          this.scrollPosition + singleItemWidth * this.visibleItemsNumber;
        ...
        if (this.scrollPosition > element.scrollWidth - singleItemWidth * 4) {
          this.scrollPosition = element.scrollWidth - singleItemWidth * 4;
        } else {
