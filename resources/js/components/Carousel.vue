    ...
    If the number of items to display is lower than the number of items per row, the items will be centered -->
        <div
            ...
            :class="[
                ...
                visibleItemsNumberSm
                    ? `row-cols-sm-${visibleItemsNumberSm}`
                    : '',
                visibleItemsNumberMd
                    ? `row-cols-md-${visibleItemsNumberMd}`
                    : '',
                visibleItemsNumberLg
                    ? `row-cols-lg-${visibleItemsNumberLg}`
                    : '',
                visibleItemsNumberXL
                    ? `row-cols-xl-${visibleItemsNumberXL}`
                    : '',
                children.length < visibleItemsNumber
        ...
        onScrollRequested(isForward) {
            ...
            if (isForward) {
                ...
                const newScrollPosition =
                    this.scrollPosition +
                    singleItemWidth * this.visibleItemsNumber;
                ...
                if (
                    this.scrollPosition >
                    element.scrollWidth - singleItemWidth * 4
                ) {
                    this.scrollPosition =
                        element.scrollWidth - singleItemWidth * 4;
                } else {
